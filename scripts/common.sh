...
JAVA_MYSQL_CONNECTOR_DOWNLOAD=https://search.maven.org/remotecontent?filepath=mysql/mysql-connector-java/${JAVA_MYSQL_CONNECTOR_VERSION}/mysql-connector-java-${JAVA_MYSQL_CONNECTOR_VERSION}.jar
